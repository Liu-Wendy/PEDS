...
public class Continue extends BaseParameters {
    ...
    public Map<Integer, Map<Integer, ArrayList<ArrayList<Integer>>>> PathMap;
...
//		}
    ...
    public void setPathMap(Map<Integer, Map<Integer, ArrayList<ArrayList<Integer>>>> pathMap) {
        PathMap = pathMap;
...
//					break;
                ...
                if (bestValue < -3100 && Math.abs(bestValue - preBestValue) < 0.00001) {
                    bestValueCount++;
